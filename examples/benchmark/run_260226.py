...
from benchmark_viz import plot_metrics_vs_budget, plot_informative_overlap, plot_final_summary_table, \
    plot_optimal_strategy_overview, plot_time_reinvestment_scenario
...
class BenchmarkRunConfig:
    ...
    amlb_categories: Sequence[str] | None = ("amlb_top20_mix",)
...
class BenchmarkReportBuilder:
    ...
    def plot_metrics_vs_budget(self, df: pd.DataFrame, output_dir: Path) -> None:
        plot_metrics_vs_budget(df, output_dir)
    ...
    def plot_optimal_strategy_overview(self, df: pd.DataFrame, output_dir: Path) -> None:
        plot_optimal_strategy_overview(df, output_dir)

    def plot_time_reinvestment_scenario(self, df: pd.DataFrame, output_dir: Path) -> None:
        plot_time_reinvestment_scenario(df,output_dir)
...
class BenchmarkOrchestrator:
    ...
    def run(self) -> Path:
        ...
        self.report_builder.plot_time_reinvestment_scenario(enriched_df, logger.paths.plots)
